...
from drjutils.common.types.sentinal import resolve
...
def resolved(value: T | object, default: R | Callable[[], R]) -> T | R:
    return default() if value is _UNSET and callable(default) else \
           default  if value is _UNSET else \
           value
